...
- 🖥️ Управление несколькими роутерами из одной панели
- 📤 Применение конфигураций сразу на несколько выбранных роутеров
- 🗂️ Индивидуальное управление выбранным роутером во вкладке
